...
fetch(json_url).then(Response => Response.json())
    ...
    // function livesearch() {
    //     let search_user = document.querySelectorAll('.search_user')
    //     let search_input = document.getElementById("search_input").value;
    //     for (var i = 0; i < search_user.length; i++) {
    //         if(search_user[i].innerText.tolowercase()
    //         .includes(search_input.tolowercase())) {
    //         search_user[i].classList.remove("is-hidden");
    //     } else {
    //         search_user[i].classList.add("is-hidden");
    //     }
    //     }
